...
# PDF_PATH = r"C:\Users\user\Desktop\LLMops\document_portal\data\document_analysis\sample.pdf"
...
#     ref_path = Path("C:\\Users\\user\\Desktop\\LLMops\\document_portal\\data\\document_compare\\Long_Report_V1.pdf")
#     act_path = Path("C:\\Users\\user\\Desktop\\LLMops\\document_portal\\data\\document_compare\\Long_Report_V2.pdf")
...
# def test_conv_rag_on_pdf(pdf_path:str, question:str):
#     try:
...
#         print("Runnig Conversational RAG...")
...
# if __name__ == "__main__":
#     pdf_path = "C:\\Users\\user\\Desktop\\LLMops\\document_portal\\data\\single_document_chat\\sample.pdf"
#     question = "what is my pdf about"

# if not Path(pdf_path).exists():
#     print(f"PDF file does not exists at : {pdf_path}")

# test_conv_rag_on_pdf(pdf_path,question)
